        ...
        <div className="min-h-screen" style={{ backgroundColor: '#F5F0E8' }}>
            ...
            <div className="max-w-6xl mx-auto p-6">
                ...
                <div className=" px-8 py-3">
                    <div className="flex items-center space-x-2 text-sm" style={{ color: '#2A2A2A' }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                    ...
                    <div className="rounded-lg p-8">
                        <div className="">
                            <h1 className="text-2xl font-bold mb-2" style={{ color: '#4B2E2B' }}>
                    ...
                    <div className="rounded-lg p-6 mt-24">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-gray-600 mb-3">Selezionato: <span className='font-bold' style={{ color: '#242424' }}>{selectedSize}</span></p>
                            <div className="grid grid-cols-3 gap-2">
                                {sizes.map((size) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-sm text-gray-600">Altezza: {size.height}</div>
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-gray-600 mb-3">Selezionato: <span className='font-bold' style={{ color: '#242424' }}>{selectedColor}</span></p>
                            <div className="flex flex-wrap gap-2">
                                {colors.map((color) => (
                                    <button
                                        key={color.name}
                                        onClick={() => setSelectedColor(color.name)}
                                        className={`w-8 h-8 rounded-full border-2 ${color.value} ${color.border} ${selectedColor === color.name ? 'ring-2 ring-offset-2' : ''}`}
                                        style={selectedColor === color.name ? { boxShadow: '0 0 0 2px #D6A77A, 0 0 0 4px white' } : {}}
                                        title={color.name}
                                    />
                        ...
                        <div className="mb-6">
                            <h3 className="font-semibold text-gray-800 mb-2">Immagine personalizzata</h3>
                            <p className="text-sm text-gray-600 mb-3">TODO: <span className='font-bold' style={{ color: '#242424' }}>TODO</span></p>
                        </div>

                        {/* Testo personalizzato */}
                        <div className="mb-6">
                            <h3 className="font-semibold text-gray-800 mb-2">Testo personalizzato</h3>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-gray-600 mb-3">Selezionato: <span className='font-bold' style={{ color: '#242424' }}>{selectedMaterial}</span></p>
                            <div className="grid grid-cols-2 gap-2">
                                {materials.map((material) => (
                                    <button
                                        key={material}
                                        onClick={() => setSelectedMaterial(material)}
                                        className={`p-3 border-2 rounded-lg text-center transition-colors ${selectedMaterial !== material ? 'border-gray-200 hover:border-gray-300' : ''
                                            }`}
                                        style={
                        ...
                        <div className="flex gap-3">
                            <button className="flex-1 bg-white py-3 px-6 rounded-lg font-medium transition-colors" style={{ color: '#4B2E2B' }}>
                                Aggiungi al carrello
                            </button>
                            <button className="flex-1 text-white py-3 px-6 rounded-lg font-medium transition-colors" style={{ backgroundColor: '#4B2E2B' }}>
                                Acquista ora
                            </button>
                        </div>
                    </div>
